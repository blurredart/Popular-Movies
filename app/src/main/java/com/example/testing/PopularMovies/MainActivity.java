...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /*Check Two Pane */
        if (findViewById(R.id.listdetail_fragment_container) != null) {
            twoPane = true;
        }
    ...
    public void initializeDetailedFragment(Bundle savedInstanceState, Movie movie) {
        ...
        if (twoPane && savedInstanceState != null && mRecyclerViewAdapter.getItemCount() != 0) {
            DetailFragment detailFragment = (DetailFragment) DetailFragment.newInstance(movie);
            getSupportFragmentManager()
                    .beginTransaction()
                    .replace(R.id.listdetail_fragment_container, detailFragment)
                    .commit();
